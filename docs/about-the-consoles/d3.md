...
The **Power switch** (momentary soft-power button) is located on the the right hand side of the console, along with a USB-A port.
...
To power down the D3 Core, press the power button once, this will display a confirmation prompt on the mini-display. Then press the power button again to confirm.
