...
&nbsp;<Keys.Annotation>O</Keys.Annotation> Ethercon ports for ArtNet or sACN output, or other network connection.
...
&nbsp;<Keys.Annotation>O</Keys.Annotation> Ethernet ports for ArtNet or sACN output, or other network connection.
