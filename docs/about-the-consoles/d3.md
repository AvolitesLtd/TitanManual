...
The D3 range includes two consoles, a standalone rack processing unit, and a touch controller.
A matching fader wing is also available (see [Fader Wings](../about-the-consoles/fader-wings.md)).
...
The D3-010 is a compact standalone console with 10 playback faders, designed for an external USB-C touchscreen.

# D3-Core

![D3-Core](/docs/images/d3-core-front.png)

The D3-Core is a 1U rack-mounted processor that runs Titan as a standalone controller

# D3-Touch

![D3-Touch](/docs/images/d3-touch-front.png)

The D3-Touch is an installation touchscreen giving simple, reliable access to a selection of playbacks on a Titan system.
