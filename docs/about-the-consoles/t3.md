...
&nbsp;<Keys.Annotation>Q</Keys.Annotation> Four optically isolated DMX outputs are provided on 5-pin XLR. Further universes can be controlled via Art-Net or sACN using the network port on the host computer.
