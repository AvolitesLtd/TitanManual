...
Go to cue           | Go to a cue in a cue list. You can either specify a cue number or just record a <em>Go</em> trigger to run the next cue. The cue will follow the fade times programmed in the cue list.
