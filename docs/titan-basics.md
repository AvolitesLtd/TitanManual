...
> **PC specifications:** Your PC should be running an in-support version of Windows 64-bit (other versions may not work correctly and we can't provide you with support). <br/>
