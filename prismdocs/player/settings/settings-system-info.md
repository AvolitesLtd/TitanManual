...
![Settings System Info](/prism-images/settings/player-settings-systeminfo.png)
...
![System CPU load](/prism-images/settings/player-CPU-system-load.png)
...
![Engine process CPU load](/prism-images/settings/player-CPU-engine-load.png)
![AiM Transcoder process CPU load](/prism-images/settings/player-CPU-transcoder-load.png)
...
![Engine process memory usage](/prism-images/settings/player-memory-engine-usage.png)
![AiM Transcoder process memory usage](/prism-images/settings/player-memory-transcoder-usage.png)