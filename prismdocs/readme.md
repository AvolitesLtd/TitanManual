...
Leave only the introduction on each folder prism, player! 
Everything else will be copied over and replaced.

- clearContent.js clears unwanted subfolder from prism and player folder, resetting the prismdocs folder in a clean state.
