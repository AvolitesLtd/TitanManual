...
When a Synergy Pixel Map is in use, the output is created from Titan only. [Pixel Map Adjustment](../stage/outputs.md#pixel-map-adjustment) is available on each DMX output.