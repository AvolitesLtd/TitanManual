...
In order to save a **{{PRISM-APP}}** project it is possible to click on `File > Save` or use the `Ctrl+S` shortcut.  
...
In order to load a **{{PRISM-APP}}** project it is possible to click on `File > Open` or use the `Ctrl+O` shortcut.  
