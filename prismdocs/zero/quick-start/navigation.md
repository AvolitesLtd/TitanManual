...
<!-- ![Prism Zero Status Bar Left](/prismdocs/images/navigation/status-bar-left.png) -->
...
<!-- ![Prism Zero Status Bar Right](/prismdocs/images/navigation/zero-status-bar-right.png) -->
