...
<Keys.HardKey>→</Keys.HardKey> bzw. <Keys.HardKey>Prev. Step</Keys.HardKey>/<Keys.HardKey>Next Step</Keys.HardKey>) bei der <Keys.HardKey>Connect</Keys.HardKey>-Taste der
...
Hauptmenü die Schrittnummer ein und drücken <Keys.HardKey>Connect</Keys.HardKey>.