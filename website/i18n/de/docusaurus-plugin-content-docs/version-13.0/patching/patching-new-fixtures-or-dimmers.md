...
Ist das Fenster 'Fixtures' nicht sichtbar, so drücken Sie <Keys.HardKey>View / Open</Keys.HardKey>, dann <Keys.HardKey>Fixture</Keys.HardKey>, oder <Keys.SoftKey>Open Workspace Window</Keys.SoftKey> gefolgt von
<Keys.SoftKey>Fixtures</Keys.SoftKey>, oder Sie rufen den Workspace <Keys.SoftKey>Fixtures and Groups</Keys.SoftKey> auf.
...
Wechseln angezeigt. Mit der Schaltfläche <Keys.SoftKey>Pages Show/Hide</Keys.SoftKey> rechts im
