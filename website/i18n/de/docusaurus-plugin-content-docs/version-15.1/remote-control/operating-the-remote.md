...
Mit den Buttons **Highlight**, **Prev** und **Next** kann man schrittweise durch die angewählten Geräte wechseln.
...
Mit der Remote lassen sich auch Paletten speichern: nehmen
...
*Cues und Gruppen können mit der Remote nicht programmiert werden.*