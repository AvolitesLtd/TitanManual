...
Wurden die Fixtures gleich als Gruppe angewählt, so wird das Gruppenlayout direkt in das neue Layout übernommen. Siehe $$$ [Adding fixtures from group layouts using Record](#) im nächsten Abschnitt.
