...
Der **Ein-/Ausschalter** (Start-Taster) befindet sich rechts am Pult, zusammen mit einer USB-A-Buchse.
...
Zum Herunterfahren wird der Ein-/Ausschalter einmal kurz betätigt; es erfolgt eine Rückfrage, ob das Pult wirklich heruntergefahren werden soll. Drücken Sie den Schalter erneut, um das Pult herunterzufahren.
