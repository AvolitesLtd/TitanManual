...
attributes are affected. To show the window double press <Keys.HardKey>View/Open</Keys.HardKey> 
...
-   You can instantly kill a playback by pressing <Keys.HardKey>Avo</Keys.HardKey> + the <strong>Select</strong>
