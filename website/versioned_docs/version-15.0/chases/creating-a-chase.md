...
5. Press the <strong>Select</strong> button of the playback to store the programmer
...
-   You can set a legend for the chase by pressing <Keys.SoftKey>Set Legend</Keys.SoftKey>, then
    pressing the <strong>Select</strong> button for the chase and entering the legend, as
    with cues.
