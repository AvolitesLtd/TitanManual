...
&nbsp;<Keys.Annotation>K</Keys.Annotation> The **Power button** is used to power the console on and off ensuring correct shutdown. Pressing it will bring up a dialogue asking if you wish to turn off the console. If the software is not running use **Turn Off Console** in the tools instead.
