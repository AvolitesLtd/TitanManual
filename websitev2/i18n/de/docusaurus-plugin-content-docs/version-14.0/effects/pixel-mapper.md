...
klicken Sie nochmals auf <Keys.ContextKey>+</Keys.ContextKey> und wählen eine <strong>Animation</strong> (Bewegung)
...
Mit der <strong>Mask FX</strong>-Funktion lassen sich Playbacks programmieren, durch die 
...
-   Diese Funktion ersetzt <strong>Block Effect</strong> aus früheren Versionen. Shows, 
