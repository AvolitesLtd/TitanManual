...
itself. It shows a list of available DMX <em>nodes</em> (places where you can
send the DMX to) on the left, and a list of the available DMX <em>lines</em>
...
From the <strong>System</strong> menu (press <Keys.HardKey>Avo</Keys.HardKey> + <Keys.HardKey>Disk</Keys.HardKey>) select <Keys.SoftKey>DMX Merge Settings</Keys.SoftKey>.
